package com.angelblog.project.system.dict.controller;
...
import com.angelblog.project.system.dict.service.IDictTypeService;
...
public class DictTypeController extends BaseController
{
    ...
    public String detail(@PathVariable("dictId") Long dictId, ModelMap mmap)
    {
        ...
        return prefix.replace("/type","") + "/data/data";
    }
