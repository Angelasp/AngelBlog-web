package com.angelblog.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;
import com.angelblog.common.constant.Constants;
import com.angelblog.common.constant.CommonMap;
import com.angelblog.common.utils.DateUtils;
import com.angelblog.common.utils.StringUtils;
import com.angelblog.framework.config.GenConfig;
import com.angelblog.project.tool.gen.domain.ColumnInfo;
import com.angelblog.project.tool.gen.domain.TableInfo;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/angelblog/project";
    ...
    public static List<String> getTemplates()
    {
        ...
        templates.add("templates/admin/vm/java/domain.java.vm");
        templates.add("templates/admin/vm/java/Mapper.java.vm");
        templates.add("templates/admin/vm/java/Service.java.vm");
        templates.add("templates/admin/vm/java/ServiceImpl.java.vm");
        templates.add("templates/admin/vm/java/Controller.java.vm");
        templates.add("templates/admin/vm/xml/Mapper.xml.vm");
        templates.add("templates/admin/vm/html/list.html.vm");
        templates.add("templates/admin/vm/html/add.html.vm");
        templates.add("templates/admin/vm/html/edit.html.vm");
        templates.add("templates/admin/vm/sql/sql.vm");
        return templates;
    }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.angelblog.project.system"));
    }
}
